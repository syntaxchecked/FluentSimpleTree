  ...
  */
  public interface IGenericTreeNode<T>
  {
    ...
    */
    ...
    /**
    <summary>Adds each node of type <typeparamref name="T"/> from <paramref name="nodesData"/> as children to the current node instance.</summary>
    ...
    */
    ...
    /**
    <summary>Adds each node in <paramref name="nodesData"/> as children to the current node instance.</summary>
    <param name="nodesData">An array of tuples (string, T data) to add.</param>
    <returns>An array of IGenericTreeNode&lt;<typeparamref name="T"/>&gt; that contains nodes that were added.</returns>
    */
    ...
    */
    ...
    /**
    <summary>Remove the child node by <paramref name="index"/> from the current instance node.</summary>
    <param name="index">An index number.</param>
    ...
    */
    ...
    /**
    <summary>Remove the child node by <paramref name="nodeId"/> from the current instance node.</summary>
    <param name="nodeId">An unique identifier.</param>
    <returns>The IGenericTreeNode&lt;<typeparamref name="T"/>&gt; that was removed.</returns>
    <exception>Thrown when the child node cannot be found by the given id.</exception>
    */
